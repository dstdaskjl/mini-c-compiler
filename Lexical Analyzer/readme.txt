Open jflex-1.6.1.jar program. Set Lexical specification file as Lexer.flex. Click "Generate" button. Then Lexer.java file will be created.


New identifiers will be stored in symboltable Hashmap and all possible token names are sotred in tokenName Hashmap.
